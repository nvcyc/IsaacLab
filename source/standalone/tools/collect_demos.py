...
parser.add_argument("--dataset_dir", type=str, default=None, help="Directory to export recorded demos.")
parser.add_argument("--step_hz", type=int, default=10, help="Environment stepping rate in Hz.")
...
import omni.isaac.groot.mimic.envs
...
def main():
    ...
    # specify directory for storing recorded demos as a dataset file
